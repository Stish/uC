...
#define AD_PIN_1 1			//Connect ADC to ad0
#define AD_PIN_2 2			//Connect ADC to ad1
...
SIGNAL (SIG_OVERFLOW0)								//a/d converter in interrupt mode
{
	...
	if (timer0_cnt == 25) //100ms
	{
		...
		//msg.data[0] = val_ad_01 >> 8;
		//msg.data[1] = val_ad_01 & 0x0ff;
		//val_ad_01
...
int main(void)								//main program
{
	...
	while(1)
	{
		...
		*/
		val_ad_01_buffer = val_ad_01;
		if (val_ad_01_buffer <= 4)
		{
			val_ad_01_buffer = 0;
		}
		else
		...
		val_ad_02_buffer = (val_ad_01 * 48828) / 100000;
